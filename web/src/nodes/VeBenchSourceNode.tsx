...
export function VeBenchSourceNode({ id, data, selected }: NodeProps) {
  ...
  return (
    <SimpleParamNode
      ...
      data={d}
      selected={selected}
      title="VE-Bench Source"
      color="var(--node-db)"
      schema={NODE_PARAM_SCHEMAS.vebench_source}
      summaryLine={() => 'VE-Bench DB (edit quality)'}
      sockets={
        <SocketHandle
