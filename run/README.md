...
| `setup_editinspector.sh` | no gateway calls (downloads public data) | Materialize a pinned, deterministic EditInspector development/confirmation slice with resumable image downloads and SHA-256 manifest. |
